...
export default async function Contact(): Promise<JSX.Element> {
  ...
  return (
    <Reveal initial={{ x: "5%" }} animate={{ x: "0%" }}>
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 xl:pl-10 -mt-14 xl:mt-20">
        <div className="w-full grid grid-cols-1 xl:grid-cols-4 items-center">
          ...
          <div className="xl:col-span-3 xl:col-start-2 border-4 border-[#30312a] px-4 sm:px-20 xl:pl-60 xl:pr-32 py-16 -mt-32 sm:-mt-40 xl:mt-0">
            <h1
              className={`relative text-2xl lg:text-4xl text-center sm:text-left z-20 ${KyivMachine.className}`}
            >
              {t("contacts.title")}
            </h1>

            <div className="relative mt-12 sm:mt-20 flex flex-col sm:flex-row justify-between items-center gap-8 sm:gap-0 text-center sm:text-left z-20">
              <ContactCard
