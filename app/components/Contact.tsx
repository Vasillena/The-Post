...
export function Contact(): JSX.Element {
  return (
    <>
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 xl:pl-10 mt-20 sm:mt-32">
        <div className="w-full grid grid-cols-1 xl:grid-cols-4  items-center">
          ...
          <div className="xl:col-span-3 xl:col-start-2 border-4 border-[#30312a] px-4 sm:px-20 xl:pl-60 xl:pr-32 py-24 -mt-32 sm:-mt-40 xl:mt-0">
            <h1
              className={`relative text-3xl lg:text-4xl text-center sm:text-left z-20 ${AmericanTypewriter.className}`}
            >
              Свържете се с нас
            </h1>
