...
export default async function About(): Promise<JSX.Element> {
  ...
  return (
    <>
      ...
      <section
        className="max-w-[1440px] mx-auto w-full h-[300px] sm:h-[560px]  mt-20 sm:mt-0 lg:mt-20 xl:mt-32 bg-center bg-contain bg-fixed touch:bg-scroll bg-[url(/decor-3-mobile.png)] sm:bg-[url(/decor-3.png)]"
        style={{
